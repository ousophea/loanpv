                        ...
                        <table  class="table table-striped dynatable">
                            ...
                            <tbody>
                                <tr class="prototype">
                                    <td>
                                        <div class="col-sm">
                                            <input type="text" class="form-control" id="vis_name" placeholder="Name" name="vis_name[]" value="<?php echo set_value('vis_name'); ?>"   >
                                    ...
                                    <td>                    
                                        <div class="col-sm">       
                                            <?php
                                            echo form_dropdown('vis_sex[]', array('m' => 'Male', 'f' => 'Female'), set_value('vis_sex'), 'id="vis_sex" class="form-control"');
                                            ?></div>
                                    </td>
                                    <td>
                                        <div class="col-sm">
                                    ...
                                    <td>
                                        <div class="col-sm">       
                                            <?php
                                            echo form_dropdown('vis_year_of_study[]', array('1' => '1', '2' => '2', '3' => '3', '4' => '4'), set_value('vis_year_of_study'), 'id="vis_year_of_study" class="form-control"');
                                            ?></div>
                                    </td>
                                    <td>                                        
                                        <div class="col-sm">
