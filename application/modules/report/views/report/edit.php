...
<form class="form-horizontal" role="form" method="post" id="reportForm" action="<?php echo site_url(); ?>report/report/edit/<?php
echo $data['rep_id'];
...
?>">
    <div class="toolbar col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        <div class="left">
            ...
            <a href="<?php echo site_url(); ?>report/report/index/<?php echo $this->uri->segment(5); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-arrow-left"></i> Back</a>
            <button  type="button" value="submit"  name="btn_update" id="btn_update"  class=" btn_update btn btn-sm btn-warning"><i class="glyphicon glyphicon-ok-circle"></i> Update</button>
        ...
        <div class="filter col-sm-10">
            <div class="form-group col-sm-4">
                ...
                <div class="input-group date col-sm-9" data-datepicker="true">
                    <input type="text" class="form-control" id="rep_sdate" placeholder="yyyy-mm-dd" name="rep_sdate"   value="<?php echo set_value('rep_sdate'); // echo $data['rep_sdate']; ?>" >
            ...
            <div class="form-group col-sm-4">
                ...
                <div class="input-group date col-sm-9 " data-datepicker="true">
                    <input type="text" class=" form-control" id="rep_edate" placeholder="yyyy-mm-dd"  name="rep_edate" value="<?php echo set_value('rep_edate'); // echo $data['rep_edate']; ?>" >
                    <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span>
                    </span>

                </div>
            </div>
            <button type="submit" class="btn btn-primary btn-sm" value="getStatistics" name="getStatistics"><i class="glyphicon glyphicon-filter"></i> Get Statistics </button>
        </div>
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ol class="h5">
                            ...
                            //                                ==========Count all visitor group by type and sex=============
                            $total_patrons = $total_patrons_f = 0;
                            $visitor_total_detail = "";
                            if ($visitorNumber->num_rows() > 0) {
                                foreach ($visitorNumber->result_array() as $row) {
                                    $total_patrons += $row['total'];
                                    $total_patrons_f += $row['f_count'];

                                    $visitor_total_detail .='<li><strong>' . $row["tvis_title"] . ' : ' . $row['total'] . '( Female: ' . $row['f_count'] . ')</strong></li>';
                                }
                            }
//                                =========================end==================
                             if (count($bookUse) > 0) {
                                ...
                                echo form_hidden('rep_id', $rep_id);
                            ?>
                            <li class="list-group-item">Total American Corner’s patrons: <strong><?php echo $total_patrons . " patrons ( Female: " . $total_patrons_f . ")" ?></strong>
                                <ul>
                                    <li>Number of patrons using Internet: <strong> <?php echo $internetUse; ?>  patrons</strong></li>
                                    <li>Number of patrons using AC’s material except Internet: <strong><?php echo $total_patrons - $internetUse; ?> patrons</strong></li>
                                </ul></li>
                    ...
                    <div class="panel-body" font="22">
                        <div class="form-group">
                            <div class="col-sm-9 dynatable ">
                                ...
                                <textarea id="txt_mce"  class="form-control tinyMCE prototype" id="rep_programs" placeholder="Comment" name="rep_programs" value="<?php echo $data['rep_programs']; ?>" ><?php echo $data['rep_programs']; ?></textarea>
...
//            $('.print').show();
        ...
        $(".btn_update").on('click', function () {
            var getURL = "<?php echo site_url(); ?>report/report/editreport";
