...
//}
?>
<form class="form-inline" id="reportForm" role="form" method="post" action="<?php echo site_url(); ?>report/report/add">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ol class="h5">
                            ...
                            if ($visitorNumber != "") {
//                                foreach ($visitorNumber as $key => $value) { // this code show on total number of UME and Publick but not f or m
//                                    $html_text.= " " . $key . '  = ' . $value;
//                                    $total += $value;
//                                }
